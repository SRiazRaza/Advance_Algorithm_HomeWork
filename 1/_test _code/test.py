...
=================================================
  ...
  Master's in Computer Science - University of Padua
    ...
    Note: lamda functions weren't used here because of bug found when a random set was missing after each iteration
...
def main():
    ...
    print("Executing Kruskal Union Find...") # Working Fine
    datasetNumber = 1
    output = "./output_kruskal_uf_" + outputfilePostfix

    #Multithreading is a problem in Python so
    for graph in graphs:
        execute_each_graph_in_dataset(output, graph, datasetNumber,fileResultLock)
        datasetNumber += 1    
